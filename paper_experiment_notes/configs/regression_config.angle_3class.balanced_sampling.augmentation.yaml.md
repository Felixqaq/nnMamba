# Config: regression/config.angle_3class.balanced_sampling.augmentation.yaml

- Source: [regression/config.angle_3class.balanced_sampling.augmentation.yaml](/home/felix/Research/nnMamba/regression/config.angle_3class.balanced_sampling.augmentation.yaml)
- Size: 2.3 KB
...
| experiment.name | Balanced sampling + aug20/class |

## Full YAML
```yaml
# nnMamba Angle Three-Class Classification with 20/Class Augmentation
# ==================================================================

experiment:
  name: Balanced sampling + aug20/class
  description: Virtual train-fold augmentation brings class 0/1 to 20 samples before per-epoch balanced sampling.

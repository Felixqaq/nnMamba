# Config: regression/config.angle_3class.balanced_sampling.augmentation100.yaml

- Source: [regression/config.angle_3class.balanced_sampling.augmentation100.yaml](/home/felix/Research/nnMamba/regression/config.angle_3class.balanced_sampling.augmentation100.yaml)
- Size: 2.3 KB
...
| experiment.name | Balanced sampling + aug100/class |

## Full YAML
```yaml
# nnMamba Angle Three-Class Classification with 100/Class Augmentation
# ===================================================================

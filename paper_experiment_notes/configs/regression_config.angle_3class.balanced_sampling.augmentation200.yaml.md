# Config: regression/config.angle_3class.balanced_sampling.augmentation200.yaml

- Source: [regression/config.angle_3class.balanced_sampling.augmentation200.yaml](/home/felix/Research/nnMamba/regression/config.angle_3class.balanced_sampling.augmentation200.yaml)
- Size: 2.3 KB
...
| experiment.name | Balanced sampling + aug200/class |

## Full YAML
```yaml
# nnMamba Angle Three-Class Classification with 200/Class Augmentation
# ===================================================================

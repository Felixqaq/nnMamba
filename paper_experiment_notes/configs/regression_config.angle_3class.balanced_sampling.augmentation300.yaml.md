# Config: regression/config.angle_3class.balanced_sampling.augmentation300.yaml

- Source: [regression/config.angle_3class.balanced_sampling.augmentation300.yaml](/home/felix/Research/nnMamba/regression/config.angle_3class.balanced_sampling.augmentation300.yaml)
- Size: 2.3 KB
...
| experiment.name | Balanced sampling + aug300/class |

## Full YAML
```yaml
# nnMamba Angle Three-Class Classification with 300/Class Augmentation
# ===================================================================

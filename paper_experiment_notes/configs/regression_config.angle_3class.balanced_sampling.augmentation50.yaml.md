# Config: regression/config.angle_3class.balanced_sampling.augmentation50.yaml

- Source: [regression/config.angle_3class.balanced_sampling.augmentation50.yaml](/home/felix/Research/nnMamba/regression/config.angle_3class.balanced_sampling.augmentation50.yaml)
- Size: 2.3 KB
...
| experiment.name | Balanced sampling + aug50/class |

## Full YAML
```yaml
# nnMamba Angle Three-Class Classification with 50/Class Augmentation
# ==================================================================

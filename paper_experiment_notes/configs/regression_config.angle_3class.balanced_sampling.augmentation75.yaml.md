# Config: regression/config.angle_3class.balanced_sampling.augmentation75.yaml

- Source: [regression/config.angle_3class.balanced_sampling.augmentation75.yaml](/home/felix/Research/nnMamba/regression/config.angle_3class.balanced_sampling.augmentation75.yaml)
- Size: 2.3 KB
...
| experiment.name | Balanced sampling + aug75/class |

## Full YAML
```yaml
# nnMamba Angle Three-Class Classification with 75/Class Augmentation
# ==================================================================

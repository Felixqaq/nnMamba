# Config: regression/config.angle_3class.tapct_attention_fusion.augmentation100.yaml

- Source: [regression/config.angle_3class.tapct_attention_fusion.augmentation100.yaml](/home/felix/Research/nnMamba/regression/config.angle_3class.tapct_attention_fusion.augmentation100.yaml)
- Size: 2.6 KB
...
| model.name | hybrid_mamba_tapct_attention_fusion |
...
| experiment.name | TAP-CT attention fusion + aug100/class |

## Full YAML
```yaml
# nnMamba Angle Three-Class Classification with TAP-CT Attention Fusion, 100/Class
# ================================================================================
...
data:
  ...
  manifest: ./datasets/generated/angle_3class_manifest.tapct_attention_fusion_aug100.json

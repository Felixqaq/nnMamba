# Config: regression/config.angle_3class.tapct_late_fusion.yaml

- Source: [regression/config.angle_3class.tapct_late_fusion.yaml](/home/felix/Research/nnMamba/regression/config.angle_3class.tapct_late_fusion.yaml)
- Size: 2.4 KB
...
| experiment.name | TAP-CT late fusion + aug300/class |

## Full YAML
```yaml
# nnMamba Angle Three-Class Classification with TAP-CT Late Fusion
# =================================================================

experiment:
  name: TAP-CT late fusion + aug300/class
  description: Hybrid Mamba-Attention CT features are concatenated with frozen TAP-CT-B patient-level embeddings before the classification head.
...
data:
  ...
  manifest: ./datasets/generated/angle_3class_manifest.tapct_late_fusion.json

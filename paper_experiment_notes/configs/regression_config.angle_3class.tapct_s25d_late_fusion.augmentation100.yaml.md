# Config: regression/config.angle_3class.tapct_s25d_late_fusion.augmentation100.yaml

- Source: [regression/config.angle_3class.tapct_s25d_late_fusion.augmentation100.yaml](/home/felix/Research/nnMamba/regression/config.angle_3class.tapct_s25d_late_fusion.augmentation100.yaml)
- Size: 2.5 KB
...
| experiment.name | TAP-CT-S-2.5D late fusion + aug100/class |

## Full YAML
```yaml
# nnMamba Angle Three-Class Classification with TAP-CT-S-2.5D Late Fusion, 100/Class
# ====================================================================================
...
data:
  ...
  manifest: ./datasets/generated/angle_3class_manifest.tapct_s25d_late_fusion_aug100.json

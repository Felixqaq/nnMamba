# Config: regression/config.angle_binary_extreme.yaml

- Source: [regression/config.angle_binary_extreme.yaml](/home/felix/Research/nnMamba/regression/config.angle_binary_extreme.yaml)
- Size: 2.3 KB
...
| experiment.name | Angle extreme binary baseline |

## Full YAML
```yaml
# nnMamba Angle Extreme Binary Classification
# ===========================================

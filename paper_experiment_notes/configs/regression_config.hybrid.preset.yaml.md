# Config: regression/config.hybrid.preset.yaml

- Source: [regression/config.hybrid.preset.yaml](/home/felix/Research/nnMamba/regression/config.hybrid.preset.yaml)
- Size: 1.6 KB
...
## Full YAML
```yaml
# nnMamba Hybrid Regression Preset
# ================================
...
data:
  ...
  manifest: ./datasets/generated/regression_manifest.hybrid.json

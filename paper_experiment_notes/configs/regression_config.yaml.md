...
- Source: [regression/config.yaml](/home/felix/Research/nnMamba/regression/config.yaml)
- Size: 1.6 KB
...
## Full YAML
```yaml
# nnMamba Regression Configuration
# =====================================

model:
  name: swinunetr  # options: mamba | hybrid_mamba_attention | swinunetr
  in_channels: 1
  hidden_dim: 128
  dropout: 0.3
  base_channels: 32
